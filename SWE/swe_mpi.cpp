...
#endif
  */
  void setDomain(int x, int y, int offsetx, int offsety, float originX, float originY);
  setDomain(l_nX, l_nY, l_blockPositionX, l_blockPositionY, l_originX, l_originY);
