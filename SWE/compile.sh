...
CFLAGS="-mtune=native -fstrict-aliasing -fargument-noalias -fopenmp -DNDEBUG -DWAVE_PROPAGATION_SOLVER=1 -DPRINT_NETCDFWRITER_INFORMATION -DSOLVER_FWAVE -DWRITENETCDF -DCOUNTFLOPS -DUSEMPI -I. -Ibuild/ -ISWE/src -ISWE/src/include $CFLAGS -fmessage-length=0 -O3 -g3"
CXX=mpiCC
